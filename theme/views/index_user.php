    ...
    <main class="container-main">
        ...
        <div class="content">
            ...
            <div class="search-content margin-top-10px">
                <a href="<?= URL_BASE ?>/usuarios/novo" class="btn-link btn-primary height-100">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    ...
                                    <a href="<?= URL_BASE . "/usuarios/editar/{$item["id"]}" ?>" class="btn btn-warning">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                             fill="currentColor"
                                    ...
                                    <a href="<?= URL_BASE . "/usuarios/apagar/{$item["id"]}" ?>" class="btn btn-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                             fill="currentColor"
