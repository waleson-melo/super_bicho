...
<main class="container-main">
    ...
    <div class="content">
        ...
        <div class="search-content margin-top-10px">
            <a href="<?= URL_BASE ?>/servicos/novo" class="btn-link btn-primary height-100">
        ...
        <div class="margin-top-10px content-table">
            <table class="table">
                ...
                <tbody>
                <?php foreach ($serivicesList as $item): ?>
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <a href="<?= URL_BASE . "/servicos/editar/{$item["id"]}" ?>" class="btn btn-warning">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                         fill="currentColor"
                                ...
                                <a href="<?= URL_BASE . "/servicos/apagar/{$item["id"]}" ?>" class="btn btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                         fill="currentColor"
